...
public class MyMeasureableDemo {
        ...
        public static void main(String[] args) {
                ...
                Autoshop res5 = new Autoshop("MusterShop", 6);
                res5.setIncome(0, 1550.25);
                res5.setIncome(1, 1500.45);
                res5.setIncome(2, 1000.0);
                res5.setIncome(3, 1200.5);
                res5.setIncome(4, 1900.0);
                res5.setIncome(5, 2000.0);
                Autoshop res6 = new Autoshop("MusterShop2", 6);
                res6.setIncome(0, 2530.79);
                res6.setIncome(1, 2854.98);
                res6.setIncome(2, 3920.20);
                res6.setIncome(3, 1250.41);
                res6.setIncome(4, 2854.26);
                res6.setIncome(5, 1990.40);
